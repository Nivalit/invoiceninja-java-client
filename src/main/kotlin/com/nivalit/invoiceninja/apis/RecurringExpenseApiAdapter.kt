...
class RecurringExpenseApiAdapter(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun uploadRecurringExpense(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, id: kotlin.String, include: kotlin.String? = null) : RecurringExpense {
        val localVarResponse = uploadRecurringExpenseWithHttpInfo(X_API_TOKEN = X_API_TOKEN, xRequestedWith = xRequestedWith, id = id, include = include)
    ...
    fun uploadRecurringExpenseWithHttpInfo(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, id: kotlin.String, include: kotlin.String?) : ApiResponse<RecurringExpense?> {
        val localVariableConfig = uploadRecurringExpenseRequestConfig(X_API_TOKEN = X_API_TOKEN, xRequestedWith = xRequestedWith, id = id, include = include)
    ...
    /**
     * To obtain the request config of the operation uploadRecurringExpense
     *
     * @param X_API_TOKEN The API token to be used for authentication
     * @param xRequestedWith Used to send the XMLHttpRequest header
     * @param id The RecurringExpense Hashed ID
     ...
     */
    fun uploadRecurringExpenseRequestConfig(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, id: kotlin.String, include: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/api/v1/recurring_expenses/{id}/upload".replace("{"+"id"+"}", encodeURIComponent(id.toString())),
