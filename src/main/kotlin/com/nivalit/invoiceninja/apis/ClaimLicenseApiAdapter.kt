...
class ClaimLicenseApiAdapter(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
     ...
     * @param licenseKey The license hash
    ...
    fun getClaimLicense(xRequestedWith: kotlin.String, licenseKey: kotlin.String, productId: kotlin.String) : Unit {
        val localVarResponse = getClaimLicenseWithHttpInfo(xRequestedWith = xRequestedWith, licenseKey = licenseKey, productId = productId)
    ...
    fun getClaimLicenseWithHttpInfo(xRequestedWith: kotlin.String, licenseKey: kotlin.String, productId: kotlin.String) : ApiResponse<Unit?> {
        val localVariableConfig = getClaimLicenseRequestConfig(xRequestedWith = xRequestedWith, licenseKey = licenseKey, productId = productId)
    ...
    /**
     * To obtain the request config of the operation getClaimLicense
     *
     * @param xRequestedWith Used to send the XMLHttpRequest header
     * @param licenseKey The license hash
     * @param productId The ID of the product purchased.
     ...
     */
    fun getClaimLicenseRequestConfig(xRequestedWith: kotlin.String, licenseKey: kotlin.String, productId: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                put("license_key", listOf(licenseKey.toString()))
