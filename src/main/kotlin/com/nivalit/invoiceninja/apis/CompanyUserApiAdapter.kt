...
class CompanyUserApiAdapter(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun updateCompanyUser(xRequestedWith: kotlin.String) : CompanyUser {
        val localVarResponse = updateCompanyUserWithHttpInfo(xRequestedWith = xRequestedWith)
    ...
    fun updateCompanyUserWithHttpInfo(xRequestedWith: kotlin.String) : ApiResponse<CompanyUser?> {
        val localVariableConfig = updateCompanyUserRequestConfig(xRequestedWith = xRequestedWith)
     ...
     */
    fun updateCompanyUserRequestConfig(xRequestedWith: kotlin.String) : RequestConfig<Unit> {
