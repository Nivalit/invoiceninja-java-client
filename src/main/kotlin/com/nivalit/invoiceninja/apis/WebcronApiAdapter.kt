...
class WebcronApiAdapter(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun webcron(xRequestedWith: kotlin.String) : Unit {
        val localVarResponse = webcronWithHttpInfo(xRequestedWith = xRequestedWith)
    ...
    fun webcronWithHttpInfo(xRequestedWith: kotlin.String) : ApiResponse<Unit?> {
        val localVariableConfig = webcronRequestConfig(xRequestedWith = xRequestedWith)
    ...
    /**
     * To obtain the request config of the operation webcron
     *
     * @param xRequestedWith Used to send the XMLHttpRequest header
     * @return RequestConfig
     */
    fun webcronRequestConfig(xRequestedWith: kotlin.String) : RequestConfig<Unit> {
