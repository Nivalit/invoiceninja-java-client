...
import com.nivalit.invoiceninja.models.Document
...
class DocumentsApiAdapter(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun getDocuments(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, include: kotlin.String? = null, index: kotlin.String? = null) : Document {
        val localVarResponse = getDocumentsWithHttpInfo(X_API_TOKEN = X_API_TOKEN, xRequestedWith = xRequestedWith, include = include, index = index)
    ...
    fun getDocumentsWithHttpInfo(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, include: kotlin.String?, index: kotlin.String?) : ApiResponse<Document?> {
        val localVariableConfig = getDocumentsRequestConfig(X_API_TOKEN = X_API_TOKEN, xRequestedWith = xRequestedWith, include = include, index = index)

        return request<Unit, Document>(
            localVariableConfig
        )
    }
     ...
     */
    fun getDocumentsRequestConfig(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, include: kotlin.String?, index: kotlin.String?) : RequestConfig<Unit> {
