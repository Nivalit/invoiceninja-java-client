...
class ImportApiAdapter(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun getImportJson(xRequestedWith: kotlin.String) : Unit {
        val localVarResponse = getImportJsonWithHttpInfo(xRequestedWith = xRequestedWith)
    ...
    fun getImportJsonWithHttpInfo(xRequestedWith: kotlin.String) : ApiResponse<Unit?> {
        val localVariableConfig = getImportJsonRequestConfig(xRequestedWith = xRequestedWith)
    ...
    /**
     * To obtain the request config of the operation getImportJson
     *
     * @param xRequestedWith Used to send the XMLHttpRequest header
     * @return RequestConfig
     */
    fun getImportJsonRequestConfig(xRequestedWith: kotlin.String) : RequestConfig<Unit> {
