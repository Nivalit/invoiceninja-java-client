...
import com.nivalit.invoiceninja.models.ClientArrayWrapped
import com.nivalit.invoiceninja.models.ClientStatementRequest
import com.nivalit.invoiceninja.models.ClientWrapped
...
class ClientsApiAdapter(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun getClients(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, include: kotlin.String? = null, index: kotlin.String? = null, status: kotlin.String? = null, createdAt: kotlin.Int? = null, updatedAt: kotlin.Int? = null, isDeleted: kotlin.Boolean? = null, filterDeletedClients: kotlin.String? = null, vendorId: kotlin.String? = null, name: kotlin.String? = null, balance: kotlin.String? = null, betweenBalance: kotlin.String? = null, email: kotlin.String? = null, idNumber: kotlin.String? = null, number: kotlin.String? = null, filter: kotlin.String? = null, sort: kotlin.String? = null) : ClientArrayWrapped {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ClientArrayWrapped
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    fun getClientsWithHttpInfo(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, include: kotlin.String?, index: kotlin.String?, status: kotlin.String?, createdAt: kotlin.Int?, updatedAt: kotlin.Int?, isDeleted: kotlin.Boolean?, filterDeletedClients: kotlin.String?, vendorId: kotlin.String?, name: kotlin.String?, balance: kotlin.String?, betweenBalance: kotlin.String?, email: kotlin.String?, idNumber: kotlin.String?, number: kotlin.String?, filter: kotlin.String?, sort: kotlin.String?) : ApiResponse<ClientArrayWrapped?> {
        ...
        return request<Unit, ClientArrayWrapped>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun showClient(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, id: kotlin.String, include: kotlin.String? = null) : ClientWrapped {
        val localVarResponse = showClientWithHttpInfo(X_API_TOKEN = X_API_TOKEN, xRequestedWith = xRequestedWith, id = id, include = include)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ClientWrapped
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * @param id The Client Hashed ID
     * @param include Include child relationships of the Client Object. (optional)
     * @return ApiResponse<ClientWrapped?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun showClientWithHttpInfo(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, id: kotlin.String, include: kotlin.String?) : ApiResponse<ClientWrapped?> {
        ...
        return request<Unit, ClientWrapped>(
            localVariableConfig
        )
    }
     ...
     * @param X_API_TOKEN The API token to be used for authentication
     * @param xRequestedWith Used to send the XMLHttpRequest header
     * @param client A request body for creating new client and update
     * @param include Include child relationships of the Client Object. (optional)
     * @return ClientWrapped
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun storeClient(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, client: Client, include: kotlin.String? = null) : ClientWrapped {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun storeClientWithHttpInfo(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, client: Client, include: kotlin.String?) : ApiResponse<ClientWrapped?> {
        ...
        return request<Client, ClientWrapped>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun updateClient(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, id: kotlin.String, client: Client, include: kotlin.String? = null) : ClientWrapped {
        val localVarResponse = updateClientWithHttpInfo(X_API_TOKEN = X_API_TOKEN, xRequestedWith = xRequestedWith, id = id, client = client, include = include)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun updateClientWithHttpInfo(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, id: kotlin.String, client: Client, include: kotlin.String?) : ApiResponse<ClientWrapped?> {
        val localVariableConfig = updateClientRequestConfig(X_API_TOKEN = X_API_TOKEN, xRequestedWith = xRequestedWith, id = id, client = client, include = include)
     ...
     * @return RequestConfig
     */
    fun updateClientRequestConfig(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, id: kotlin.String, client: Client, include: kotlin.String?) : RequestConfig<Client> {
        val localVariableBody = client
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (include != null) {
