...
class OneTimeTokenApiAdapter(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun oneTimeToken(xRequestedWith: kotlin.String) : Unit {
        val localVarResponse = oneTimeTokenWithHttpInfo(xRequestedWith = xRequestedWith)
    ...
    fun oneTimeTokenWithHttpInfo(xRequestedWith: kotlin.String) : ApiResponse<Unit?> {
        val localVariableConfig = oneTimeTokenRequestConfig(xRequestedWith = xRequestedWith)
    ...
    /**
     * To obtain the request config of the operation oneTimeToken
     *
     * @param xRequestedWith Used to send the XMLHttpRequest header
     * @return RequestConfig
     */
    fun oneTimeTokenRequestConfig(xRequestedWith: kotlin.String) : RequestConfig<Unit> {
