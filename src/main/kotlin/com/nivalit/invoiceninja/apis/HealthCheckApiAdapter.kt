...
class HealthCheckApiAdapter(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun getHealthCheck(xRequestedWith: kotlin.String) : Unit {
        val localVarResponse = getHealthCheckWithHttpInfo(xRequestedWith = xRequestedWith)
    ...
    fun getHealthCheckWithHttpInfo(xRequestedWith: kotlin.String) : ApiResponse<Unit?> {
        val localVariableConfig = getHealthCheckRequestConfig(xRequestedWith = xRequestedWith)
    ...
    /**
     * To obtain the request config of the operation getHealthCheck
     *
     * @param xRequestedWith Used to send the XMLHttpRequest header
     * @return RequestConfig
     */
    fun getHealthCheckRequestConfig(xRequestedWith: kotlin.String) : RequestConfig<Unit> {
