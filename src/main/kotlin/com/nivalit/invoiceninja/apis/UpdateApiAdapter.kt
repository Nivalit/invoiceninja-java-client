...
class UpdateApiAdapter(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun selfUpdate(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, X_API_PASSWORD: kotlin.String? = null, include: kotlin.String? = null) : Unit {
        val localVarResponse = selfUpdateWithHttpInfo(X_API_TOKEN = X_API_TOKEN, xRequestedWith = xRequestedWith, X_API_PASSWORD = X_API_PASSWORD, include = include)
    ...
    fun selfUpdateWithHttpInfo(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, X_API_PASSWORD: kotlin.String?, include: kotlin.String?) : ApiResponse<Unit?> {
        val localVariableConfig = selfUpdateRequestConfig(X_API_TOKEN = X_API_TOKEN, xRequestedWith = xRequestedWith, X_API_PASSWORD = X_API_PASSWORD, include = include)
    ...
    /**
     * To obtain the request config of the operation selfUpdate
     *
     * @param X_API_TOKEN The API token to be used for authentication
     * @param xRequestedWith Used to send the XMLHttpRequest header
     * @param X_API_PASSWORD The login password when challenged on certain protected routes (optional)
     ...
     */
    fun selfUpdateRequestConfig(X_API_TOKEN: kotlin.String, xRequestedWith: kotlin.String, X_API_PASSWORD: kotlin.String?, include: kotlin.String?) : RequestConfig<Unit> {
